...
void loop()
{
  digitalWrite(row1, HIGH); digitalWrite(col2, HIGH);
  digitalWrite(row1, LOW); digitalWrite(col2, LOW);
  delay(1);
  digitalWrite(row2, HIGH); digitalWrite(col1, HIGH);
  digitalWrite(row2, LOW); digitalWrite(col1, LOW);
  delay(1);
}
